...
class ABCService(ABC):
	...
	def create_blueprint(self, name: str, *args, parent: 'ABCService | None' = None, import_name: str | None = None, **kwargs) -> Blueprint:
		"""
		...
		Args:
			...
			*args: Positional arguments forwarded to Blueprint()
			parent: Optional parent service to register this blueprint with
